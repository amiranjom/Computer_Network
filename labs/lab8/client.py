...
# Student Name: Amir R. Anjomshoaa
# Student ID: 918710278
# Student Github Username: amiranjom
...
class Client(object):
    ...
    def __init__(self):
        ...
        self.client_id = None
        self.student_name = "Amir R Anjomshoaa"
        self.github_username = "amiranjom"
        self.sid = 918710278
    ...
    def _bind(self,port,ip="0.0.0.0"):
    ...
    def set_client_id(self):
        ...
        print("Client id " + str(self.client_id) + " assigned by server: "  + str(self.ip) + " port: " + str(self.port))
